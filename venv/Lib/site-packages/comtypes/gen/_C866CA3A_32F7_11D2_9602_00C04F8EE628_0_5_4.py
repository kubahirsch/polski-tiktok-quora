...
__all__ = [
    'SpeechRecognitionType', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SOTRemove', 'DISPID_SVSLastResult', 'SRESoundStart',
    'SAFT24kHz8BitStereo', 'SPAUDIOSTATUS', 'SpeechBookmarkOptions',
    'SVEVoiceChange', 'ISpeechWaveFormatEx', 'DISPID_SPACommit',
    'SpeechPropertyHighConfidenceThreshold', 'SPSHT_OTHER',
    'ISpeechGrammarRules', 'SVSFlagsAsync', 'SRAONone',
    'DISPID_SVAlertBoundary', 'DISPID_SRRecognizer',
    'SGRSTTTextBuffer', 'SVSFIsXML', 'ISpRecoContext',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SGRSTTWord', 'DISPID_SLWsItem',
    'SGDSActive', 'DISPID_SVGetAudioOutputs', 'SBONone',
    'SpNullPhoneConverter', 'UINT_PTR', 'SpeechVoicePriority',
    'DISPIDSPTSI_SelectionOffset', 'SPPHRASEELEMENT', 'SPAR_High',
    'DISPID_SRDisplayUI', 'ISpStreamFormat', 'SPEVENTSOURCEINFO',
    'SpeechCategoryAudioOut', 'DISPID_SRSAudioStatus',
    'SPWAVEFORMATTYPE', 'DISPID_SOTCGetDataKey', 'DISPID_SRCState',
    'DISPID_SPRs_NewEnum', 'DISPID_SVRate', 'SRADefaultToActive',
    'DISPID_SpeechRecoContextEvents', 'SVSFNLPSpeakPunc',
    'SRERecognition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SVVolume', 'DISPID_SLPPartOfSpeech',
    'ISpeechMemoryStream', 'DISPID_SRRGetXMLResult',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPEEngineConfidence', 'SAFTNoAssignedFormat',
    'DISPID_SRCEPhraseStart', 'DISPID_SpeechPhraseReplacement',
    'SAFT48kHz8BitStereo', 'SPPS_Function', 'SPAS_RUN',
    'SPINTERFERENCE_NOSIGNAL', 'SVSFParseAutodetect',
    'DISPID_SGRSTType', 'DISPID_SRCERecognition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpRecoResult',
    'SpFileStream', 'SpeechVisemeType', 'DISPID_SRCEBookmark',
    'SpMemoryStream', 'SPSHORTCUTTYPE', 'SAFTADPCM_44kHzMono',
    'DISPID_SOTId', 'SAFT32kHz16BitMono', 'SpLexicon',
    'eLEXTYPE_PRIVATE19', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPSNotOverriden', 'SAFTGSM610_44kHzMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpPhoneticAlphabetConverter', 'SPEI_RECO_STATE_CHANGE',
    'ISpeechPhoneConverter', 'DISPID_SGRId', 'DISPID_SPRuleId',
    'DISPID_SPAPhraseInfo', 'DISPID_SOTsCount', 'SRERequestUI',
    'SVEStartInputStream', 'DISPID_SGRClear',
    'DISPID_SPAStartElementInResult', 'SAFT16kHz16BitMono',
    'ISpPhoneticAlphabetSelection', 'DISPID_SDKGetlongValue',
    'ISpeechPhraseReplacements', 'DISPID_SpeechMMSysAudio',
    'ISpObjectTokenCategory', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechLexiconWord', 'SPEI_PROPERTY_STRING_CHANGE',
    'SVEAllEvents', 'DISPID_SOTCDefault', 'SPEI_WORD_BOUNDARY',
    'SSFMCreate', 'ISpEventSource', 'SGSDisabled',
    'SpeechRetainedAudioOptions', 'DISPID_SRGetRecognizers',
    'DISPID_SPPParent', 'SpeechAudioFormatGUIDWave',
    'DISPID_SGRSTWeight', 'DISPID_SLWType', 'SpeechRecoEvents',
    'SRCS_Disabled', 'SLODynamic', 'ISpXMLRecoResult',
    'DISPID_SRProfile', 'SpeechStreamSeekPositionType',
    'SpeechRuleState', 'SAFT32kHz8BitStereo', 'SAFT16kHz8BitStereo',
    'SpeechAudioProperties', 'SVP_4',
    'DISPID_SRCEPropertyNumberChange', 'SPSHORTCUTPAIRLIST',
    'SGPronounciation', 'SAFT22kHz16BitStereo', 'SPWORDLIST',
    'DISPID_SVSVisemeId', 'SpeechEngineConfidence', 'SDTLexicalForm',
    'SPBO_AHEAD', 'DISPID_SRCSetAdaptationData', 'SPSInterjection',
    'SECFDefault', 'ISpeechObjectTokens',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SPPName',
    'SGDSActiveUserDelimited', 'DISPID_SpeechGrammarRule',
    'SPEI_FALSE_RECOGNITION', 'SPPS_LMA', 'SpWaveFormatEx',
    'DISPID_SVEStreamEnd', 'DISPID_SVSLastStreamNumberQueued',
    'SPRULESTATE', 'SpeechRecoContextState', 'DISPID_SPPChildren',
    'DISPID_SVEWord', 'ISpAudio', 'SAFT22kHz8BitMono', 'SRTEmulated',
    'ISpNotifyTranslator', 'SDTRule', '_ISpeechRecoContextEvents',
    'DISPID_SpeechPhraseProperties', 'SPEI_END_INPUT_STREAM',
    'eLEXTYPE_PRIVATE6', 'SAFT48kHz16BitStereo', 'DISPID_SGRSTsCount',
    'SAFT32kHz8BitMono', 'ISpeechRecognizerStatus',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPRULE', 'STSF_FlagCreate',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPBO_TIME_UNITS', 'SPPS_Noun',
    'DISPID_SASetState', 'ISpRecoGrammar', 'SPEI_INTERFERENCE',
    'SPEI_RESERVED1', 'SPDKL_DefaultLocation', 'SPSSuppressWord',
    'SVP_3', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SLPsCount', 'SPEI_REQUEST_UI', 'SPFM_OPEN_READONLY',
    'ISpeechAudioBufferInfo', 'ISpeechResourceLoader',
    'DISPID_SGRName', 'ISpMMSysAudio', 'ISpeechPhraseRules',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechVoiceStatus', 'SBOPause',
    'SpeechCategoryRecoProfiles', 'DISPID_SLGenerationId',
    'ISpObjectWithToken', 'DISPID_SVSLastBookmarkId',
    'SpeechEmulationCompareFlags', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SWFEBitsPerSample', 'DISPID_SDKEnumValues',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_19',
    'SREStreamEnd', 'DISPID_SLGetWords', 'SAFT48kHz8BitMono',
    'SpVoice', 'SSFMOpenReadWrite', 'eLEXTYPE_PRIVATE9', 'SITooLoud',
    'SITooFast', 'DISPID_SPRFirstElement', 'SVSFParseMask',
    'SPEI_MIN_SR', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRRAlternates', 'DISPID_SASCurrentDevicePosition',
    'SVP_9', 'ISpeechRecoResult2', 'DISPID_SPIGrammarId',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPERetainedStreamOffset',
    'SRERecoOtherContext', 'SpeechRegistryLocalMachineRoot',
    'LONG_PTR', 'SpCustomStream', 'DISPID_SPILanguageId',
    'DISPID_SPRuleFirstElement', 'ISpeechAudioStatus',
    'DISPID_SVAudioOutputStream', 'DISPID_SRGSetTextSelection',
    'IInternetSecurityManager', 'DISPID_SRRTTickCount',
    'SPSHT_Unknown', 'SPSFunction', 'SDTPronunciation',
    'DISPID_SLAddPronunciation', 'ISpRecognizer',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPFM_CREATE_ALWAYS', 'SVF_None',
    'SPVOICESTATUS', 'SPPS_NotOverriden', 'SECNormalConfidence',
    'DISPID_SVESentenceBoundary', 'STSF_CommonAppData',
    'SpeechTokenContext', 'DISPID_SPRuleEngineConfidence',
    'SVSFUnusedFlags', 'ISpeechFileStream', 'SVP_5',
    'DISPID_SRCVoice', 'ISpeechRecoResultTimes', 'SVP_16',
    'SAFT16kHz16BitStereo', 'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpeechDataKey', 'SpeechRuleAttributes', 'DISPID_SPCLangId',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGCmdLoadFromFile',
    'SRSInactive', 'SpNotifyTranslator', 'SVSFPurgeBeforeSpeak',
    'ISpPhoneConverter', 'DISPID_SGRSTsItem', 'ISpeechVoice',
    'DISPID_SPARecoResult', 'DISPID_SRGCmdLoadFromMemory',
    'SPAS_STOP', 'SpeechFormatType', 'SPEI_TTS_PRIVATE',
    'SVF_Emphasis', 'DISPID_SPRulesCount', 'SpResourceManager',
    'SPWORDPRONUNCIATION', 'DISPID_SPRuleParent',
    'DISPID_SVIsUISupported', 'ISpeechGrammarRuleStateTransitions',
    'SP_VISEME_0', 'Speech_StreamPos_Asap', 'SVEWordBoundary',
    'SpeechGrammarState', 'SWPKnownWordPronounceable',
    'SPEI_VOICE_CHANGE', 'SpeechDiscardType', 'SVEPrivate',
    'SPAS_PAUSE', 'DISPID_SRGDictationLoad', 'SGSExclusive',
    'SGRSTTWildcard', 'DISPID_SPPsItem', 'SPEI_MAX_TTS',
    'DISPID_SRGState', 'DISPID_SGRSTPropertyId', 'SPVPRI_OVER',
    'SVPOver', 'SP_VISEME_4', 'SAFTNonStandardFormat',
    'SpeechGrammarTagUnlimitedDictation', 'SSFMOpenForRead', 'SDTAll',
    'SLOStatic', 'SAFTCCITT_ALaw_44kHzMono', '__MIDL_IWinTypes_0009',
    'ISpeechPhraseReplacement', 'DISPID_SOTCSetId',
    'DISPID_SRGetPropertyString', 'SRTSMLTimeout',
    'DISPID_SRCEventInterests', 'DISPID_SPERetainedSizeBytes',
    'SPEI_END_SR_STREAM', 'SpeechTokenKeyAttributes',
    'DISPID_SWFEAvgBytesPerSec', 'SSTTDictation', 'SECFIgnoreWidth',
    'eLEXTYPE_PRIVATE18', 'SPPS_RESERVED3', 'SAFTADPCM_8kHzMono',
    'SPWT_DISPLAY', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPWF_INPUT',
    'ISpGrammarBuilder', 'DISPID_SVSInputWordLength',
    'DISPID_SGRsAdd', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechGrammarRuleState', 'SPRS_INACTIVE',
    'DISPID_SRRAudio', 'DISPID_SRIsShared',
    'DISPID_SVSInputSentencePosition', 'SAFT16kHz8BitMono',
    'ISpeechAudio', 'SPLEXICONTYPE', 'DISPID_SLWLangId',
    'DISPID_SASCurrentSeekPosition', 'SPVPRIORITY',
    'DISPID_SRCESoundStart', 'DISPID_SRRTLength',
    'IEnumSpObjectTokens', 'tagSPPROPERTYINFO', 'SPSHT_EMAIL',
    'DISPID_SOTGetAttribute', 'STCInprocHandler',
    'DISPID_SRCRecognizer', 'SSTTTextBuffer',
    'SpeechRegistryUserRoot', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechFileStream', 'DISPID_SPRuleNumberOfElements',
    'SPPS_RESERVED2', 'DISPID_SPIGetDisplayAttributes',
    'SGDSActiveWithAutoPause', 'DISPID_SDKOpenKey',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_PRIVATE5',
    'SDA_Two_Trailing_Spaces', 'DISPID_SRRDiscardResultInfo',
    'SAFT11kHz16BitMono', 'SpeechLexiconType', 'SDTAlternates',
    'SpeechMicTraining', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechBaseStream', 'DISPIDSPTSI_ActiveLength',
    'SPPS_Unknown', 'SPINTERFERENCE_TOOFAST', 'DISPID_SLPs_NewEnum',
    'ISpeechPhraseElement', 'ISpeechXMLRecoResult',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SOTsItem',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SRRTStreamTime', 'DISPID_SVPriority', 'DISPID_SVStatus',
    'SPINTERFERENCE_TOOQUIET', 'SAFTCCITT_uLaw_22kHzMono',
    'SPBO_PAUSE', 'DISPID_SGRSTPropertyName',
    'DISPID_SDKGetBinaryValue', 'DISPID_SVSRunningState',
    'SPRS_ACTIVE', 'SpeechPropertyLowConfidenceThreshold',
    'SPPHRASERULE', 'SpMMAudioEnum', 'Speech_StreamPos_RealTime',
    'DISPID_SGRSAddWordTransition', 'SAFTADPCM_22kHzStereo',
    'DISPID_SGRsDynamic', 'IStream', 'SDTProperty',
    'SpTextSelectionInformation', 'DISPID_SASState', 'SPEI_MAX_SR',
    'DISPID_SRState', 'ISpStreamFormatConverter', 'SP_VISEME_5',
    'ISpRecoCategory', 'DISPID_SPEsItem', 'ISpeechRecoResultDispatch',
    'DISPID_SOTSetId', 'DISPID_SRCEEndStream', 'SVP_11',
    'DISPID_SRAudioInput', 'DISPID_SpeechPhraseBuilder',
    'SPGS_EXCLUSIVE', 'DISPID_SGRSTs_NewEnum', 'SPLOADOPTIONS',
    'SPSVerb', 'DISPID_SRRSaveToMemory', 'SPEI_SENTENCE_BOUNDARY',
    'SpeechPropertyComplexResponseSpeed', 'SpeechUserTraining',
    'DISPID_SDKDeleteValue', 'SFTInput', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRCEEnginePrivate', 'SPFM_CREATE', 'DISPID_SPCIdToPhone',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpRecoContext2', 'SPCS_DISABLED',
    'tagSTATSTG', 'SpeechCategoryAppLexicons', 'ISpRecognizer2',
    'SPTEXTSELECTIONINFO', 'SPEI_RESERVED6', 'DISPID_SDKEnumKeys',
    '_ISpeechVoiceEvents', 'DISPID_SRGCommit', 'SP_VISEME_2',
    'ISpeechMMSysAudio', 'SECFNoSpecialChars', 'SDKLLocalMachine',
    'ISpResourceManager', 'SpInProcRecoContext',
    'DISPID_SpeechAudioStatus', 'SPGRAMMARSTATE',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGetFormat', 'SVP_1',
    'DISPID_SpeechVoice', 'SAFTText', 'SAFTADPCM_11kHzMono',
    'DISPID_SAStatus', 'SWTDeleted',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechXMLRecoResult', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SRRSetTextFeedback', 'SPEI_RESERVED5',
    'DISPID_SMSADeviceId', 'SpeechPropertyResponseSpeed',
    'DISPID_SLWsCount', 'SPCT_DICTATION', 'Speech_Default_Weight',
    'DISPID_SRStatus', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTGSM610_22kHzMono', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SP_VISEME_12', 'SPWORDTYPE', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRSCurrentStreamPosition', 'DISPIDSPTSI_ActiveOffset',
    'SpeechTokenValueCLSID', 'SPEI_SR_BOOKMARK', 'DISPID_SGRSTText',
    'SP_VISEME_17', 'SPPS_Verb', 'SpeechRunState',
    'DISPID_SRCERequestUI', 'SRTStandard', 'SPEI_RESERVED2',
    'SLTUser', 'SVEBookmark', 'SVP_20', 'IEnumString',
    'SSSPTRelativeToEnd', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRSetPropertyString', 'SpShortcut', 'DISPID_SVEPhoneme',
    'SPWORD', 'SPEI_PHRASE_START', 'SAFT32kHz16BitStereo',
    'SPDKL_LocalMachine', 'DISPID_SRCERecognitionForOtherContext',
    'SRSEIsSpeaking', 'SREInterference', 'DISPID_SBSRead',
    'DISPID_SpeechLexiconPronunciation', 'SVP_15',
    'DISPID_SOTDisplayUI', 'ISpPhrase', 'DISPID_SADefaultFormat',
    'SPBO_NONE', 'STCRemoteServer', 'DISPID_SPEs_NewEnum',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPRsCount', 'ISpeechObjectToken',
    'DISPID_SRCRetainedAudio', 'SECFIgnoreKanaType', 'SPEI_UNDEFINED',
    'DISPID_SRCCmdMaxAlternates', 'SPEI_ADAPTATION',
    'SpeechAudioState', 'eLEXTYPE_RESERVED6', 'DISPID_SAVolume',
    'SPAO_RETAIN_AUDIO', 'DISPID_SABIBufferSize', 'SPVPRI_NORMAL',
    'SITooQuiet', 'STCAll', 'SPEVENT', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTGSM610_11kHzMono', 'DISPID_SMSGetData', 'SPEI_RESERVED3',
    'DISPID_SGRInitialState', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechTokenKeyUI', 'SpInprocRecognizer',
    'SPINTERFERENCE_TOOLOUD', 'SREPrivate',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRSTPropertyValue',
    'DISPID_SLWWord', 'SRTReSent', 'SVEPhoneme', 'eWORDTYPE_ADDED',
    'DISPID_SVGetVoices', 'SPGS_DISABLED',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPIReplacements',
    'DISPID_SOTCId', 'SPSERIALIZEDRESULT', 'SPEVENTENUM',
    'DISPID_SDKCreateKey', 'SAFTDefault',
    'DISPID_SPIEnginePrivateData', 'SP_VISEME_15',
    'SpeechVisemeFeature', 'SpeechPartOfSpeech',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPPId', 'SpStream',
    'ISpPhoneticAlphabetConverter', 'SPLO_STATIC',
    'SpeechVoiceCategoryTTSRate', 'SPEI_SR_AUDIO_LEVEL', 'SVP_13',
    'SASStop', 'SVP_19', 'ISpeechPhraseRule', 'SINoise',
    'DISPID_SFSOpen', 'SPDATAKEYLOCATION', 'DISPID_SPRules_NewEnum',
    'SpeechTokenIdUserLexicon', 'SDA_Consume_Leading_Spaces',
    'ISpDataKey', 'eLEXTYPE_USER', 'SRSActive',
    'DISPID_SRIsUISupported', 'SpeechGrammarWordType',
    'SPPS_RESERVED1', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRCERecognizerStateChange', 'SINoSignal',
    'DISPID_SpeechPhraseAlternates', 'SpeechPropertyResourceUsage',
    'DISPID_SREmulateRecognition', 'SpAudioFormat',
    'SAFT12kHz8BitStereo', 'SWTAdded', 'DISPID_SPEDisplayText',
    'SPSTREAMFORMATTYPE', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SAFSetWaveFormatEx', 'SSTTWildcard', 'DISPID_SPPValue',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRCRequestedUIType',
    'ISpeechBaseStream', 'SPSUnknown', 'SGRSTTRule',
    'eLEXTYPE_PRIVATE1', 'SVSFParseSapi', 'SVSFPersistXML',
    'SPSHORTCUTPAIR', 'DISPID_SPELexicalForm',
    'DISPID_SPERequiredConfidence', 'SREAllEvents',
    'SPINTERFERENCE_NOISE', 'SDA_No_Trailing_Space',
    'SRAORetainAudio', 'DISPID_SPPFirstElement', 'SVP_18',
    'DISPID_SpeechPhraseReplacements', 'SPWT_LEXICAL',
    'eLEXTYPE_PRIVATE2', 'SDTAudio', 'SpeechCategoryVoices',
    'DISPID_SPPNumberOfElements', 'DISPIDSPTSI', 'SAFT12kHz16BitMono',
    'DISPID_SGRAttributes', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVSpeakStream', 'DISPID_SABufferNotifySize', 'SPCT_SLEEP',
    'SPEI_HYPOTHESIS', 'SPXMLRESULTOPTIONS',
    'DISPID_SPIAudioStreamPosition', 'SREPropertyNumChange',
    'DISPID_SpeechPhraseRules', 'DISPID_SRCreateRecoContext',
    'SRARoot', 'SPSEMANTICERRORINFO', 'DISPID_SVAudioOutput',
    'SP_VISEME_13', 'DISPID_SRRRecoContext', 'SVP_10',
    'ISpeechLexiconWord', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCEInterference', 'SRSActiveAlways', 'SPEI_VISEME',
    'SPWORDPRONUNCIATIONLIST', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SVPause', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechLexiconProns', 'SAFTGSM610_8kHzMono',
    'DISPID_SPCPhoneToId', 'DISPID_SPIGetText',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SpeechRecognizerState',
    'SINone', 'SPXRO_Alternates_SML', 'ISpeechLexiconWords',
    'ISpeechPhraseInfo', 'DISPID_SVEVoiceChange', 'SVP_14',
    'DISPID_SRGId', 'SPAO_NONE', 'SAFT44kHz16BitMono',
    'SPRECOGNIZERSTATUS', 'SPPARTOFSPEECH', 'ISpShortcut',
    'SVPNormal', 'SGRSTTDictation', 'SPAUDIOOPTIONS',
    'SPFM_OPEN_READWRITE', 'SpUnCompressedLexicon',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPPS_Noncontent',
    'DISPID_SVGetAudioInputs', 'DISPID_SAFGuid',
    'DISPID_SpeechLexicon', 'ISpeechRecoContext',
    'SpeechAudioFormatType', 'DISPID_SABIMinNotification',
    'DISPIDSPRG', 'eLEXTYPE_RESERVED10', 'SPLO_DYNAMIC',
    'SP_VISEME_16', 'DISPID_SDKSetLongValue', 'SPBOOKMARKOPTIONS',
    'WAVEFORMATEX', 'SpMMAudioIn', 'ISpeechPhraseAlternates',
    'SpeechVoiceSkipTypeSentence', 'ISpeechLexiconPronunciations',
    'SPAR_Medium', 'DISPID_SWFEFormatTag', 'DISPID_SPAsCount',
    'eLEXTYPE_PRIVATE11', 'DISPID_SBSWrite', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_PRIVATE4', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPIRule', 'SAFT24kHz16BitStereo',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SWFEChannels',
    'DISPID_SPRsItem', 'SPXRO_SML', 'SP_VISEME_14',
    'DISPID_SGRsCommitAndSave', 'DISPID_SMSSetData',
    'DISPID_SPIAudioSizeTime', 'SPRST_ACTIVE', 'SPCS_ENABLED',
    'DISPID_SVEAudioLevel', 'SECHighConfidence', 'SPCT_SUB_DICTATION',
    'DISPID_SPRuleConfidence', 'SVP_7', 'DISPID_SGRSTransitions',
    'SREAdaptation', 'DISPID_SPEDisplayAttributes',
    'ISpeechPhraseProperty', 'ISpeechObjectTokenCategory',
    'STCLocalServer', 'DISPID_SLPPhoneIds', 'SSSPTRelativeToStart',
    'DISPID_SLPLangId', 'SPDKL_CurrentUser', 'DISPID_SVSkip',
    'DISPID_SVDisplayUI', 'DISPID_SPAsItem', 'SAFT44kHz8BitMono',
    'SRAExport', 'SpeechEngineProperties', 'ISequentialStream',
    'DISPID_SRRTimes', 'ISpVoice', 'DISPID_SRRTOffsetFromStart',
    'SPWT_PRONUNCIATION', 'eLEXTYPE_PRIVATE14', 'SLTApp',
    'DISPID_SRCEHypothesis', 'SGRSTTEpsilon', 'DISPID_SGRsCommit',
    'SAFT24kHz16BitMono', 'DISPID_SGRsFindRule',
    'DISPID_SRGRecoContext', 'DISPID_SGRsItem', 'SAFT8kHz16BitStereo',
    'DISPID_SCSBaseStream', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SpeechAudio', 'DISPID_SGRs_NewEnum', 'SRAImport',
    'ISpeechVoiceStatus', 'SREAudioLevel', 'DISPID_SpeechRecoResult2',
    'Speech_Max_Pron_Length', 'IInternetSecurityMgrSite',
    'DISPID_SRRGetXMLErrorInfo', 'SPRECOCONTEXTSTATUS',
    'SPAR_Unknown', 'DISPID_SGRSTRule', 'DISPID_SRRAudioFormat',
    'DISPID_SVEStreamStart', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechRecoResult', 'SREStateChange', 'SDTDisplayText',
    'DISPID_SVGetProfiles', 'DISPID_SPPsCount', 'SGSEnabled',
    'SGDSInactive', 'DISPID_SPEAudioSizeBytes', 'SPFILEMODE',
    'DISPID_SOTGetDescription', 'SAFT8kHz8BitMono', '_SPAUDIOSTATE',
    'DISPID_SVSPhonemeId', 'SRATopLevel', 'SASClosed', 'SVF_Stressed',
    'ISpeechGrammarRuleState', 'SVSFParseSsml',
    'DISPID_SRGCmdSetRuleIdState', 'SPRECOSTATE', 'SREStreamStart',
    'SPCATEGORYTYPE', 'DISPID_SOTs_NewEnum', 'SAFT12kHz16BitStereo',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPIElements', 'DISPID_SABufferInfo',
    'SPRST_NUM_STATES', 'SDA_One_Trailing_Space', 'SITooSlow',
    'SpeechAudioVolume', 'DISPID_SMSAMMHandle',
    'DISPID_SPEPronunciation', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SDKSetBinaryValue', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SpeechGrammarRules', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechPhraseElement', 'eLEXTYPE_VENDORLEXICON',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpeechCategoryAudioIn',
    'DISPID_SVVoice', 'SPPHRASE', 'DISPID_SPISaveToMemory',
    'SPSHT_NotOverriden', 'DISPID_SPEsCount',
    'SpeechGrammarTagDictation', 'DISPID_SLPSymbolic',
    'SpeechWordPronounceable', 'SPSMF_UPS',
    'DISPID_SRGDictationSetState', 'SpeechSpecialTransitionType',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechPhraseElements',
    'SPAS_CLOSED', 'ISpeechPhraseElements', 'SAFTADPCM_22kHzMono',
    'SPGS_ENABLED', 'SPVPRI_ALERT', 'ISpeechPhraseProperties',
    '_RemotableHandle', 'SPVISEMES', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_USER_SHORTCUT', 'eLEXTYPE_PRIVATE10',
    'SpCompressedLexicon', 'DISPID_SPRText',
    'DISPID_SLGetPronunciations', 'SREHypothesis', 'SDKLCurrentUser',
    'SRAInterpreter', 'SVSFNLPMask', 'SPSNoun', 'SAFT8kHz8BitStereo',
    'SVEAudioLevel', 'DISPID_SRGCmdLoadFromObject', 'STCInprocServer',
    'DISPID_SPPEngineConfidence', 'SpeechDictationTopicSpelling',
    'ISpSerializeState', 'SpeechPropertyAdaptationOn',
    'ISpeechGrammarRule', 'ISpRecoGrammar2', 'ISpeechAudioFormat',
    'DISPID_SVEViseme', 'DISPID_SLWs_NewEnum',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPIAudioSizeBytes',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPEAudioStreamOffset',
    'SpeechDisplayAttributes', 'DISPID_SAEventHandle', 'SGDisplay',
    'DISPID_SPRDisplayAttributes', 'eLEXTYPE_PRIVATE3',
    'SVSFIsNotXML', 'SPRECORESULTTIMES', 'eLEXTYPE_APP',
    'DISPID_SBSFormat', 'DISPID_SPPs_NewEnum', 'SAFT11kHz8BitStereo',
    'DISPID_SPEAudioTimeOffset', 'SPEI_MIN_TTS', 'ISpeechRecognizer',
    'DISPID_SVEBookmark', 'SPPROPERTYINFO', 'DISPID_SRCPause',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPRuleChildren',
    'SPPS_RESERVED4', 'SREPropertyStringChange', 'SPSEMANTICFORMAT',
    'SP_VISEME_1', 'DISPID_SpeechPhraseProperty', 'SRCS_Enabled',
    'DISPID_SOTMatchesAttributes', 'SPSLMA',
    'DISPID_SRCCreateGrammar', 'DISPID_SWFEBlockAlign',
    'SRTExtendableParse', 'SpeechLoadOption', 'SPPS_Interjection',
    'DISPID_SLPType', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_SR_PRIVATE', 'SDKLDefaultLocation',
    'DISPID_SOTIsUISupported', 'DISPID_SpeechAudioBufferInfo',
    'SDKLCurrentConfig', 'ISpPhraseAlt', 'DISPID_SRGReset',
    'SPEI_TTS_BOOKMARK', 'SPRST_INACTIVE_WITH_PURGE', 'SGLexical',
    'DISPID_SDKDeleteKey', 'DISPID_SRRSpeakAudio',
    'SPWORDPRONOUNCEABLE', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_PRIVATE20',
    'DISPID_SDKGetStringValue', 'SpeechStreamFileMode',
    'DISPID_SLRemovePronunciation',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechObjectToken', 'SpSharedRecognizer',
    'DISPID_SWFEExtraData', 'SECFEmulateResult', 'DISPID_SVSpeak',
    'DISPID_SPPConfidence', 'SPGRAMMARWORDTYPE', 'SpObjectToken',
    'DISPID_SRGCmdLoadFromResource', 'ISpStream', 'SP_VISEME_6',
    'eLEXTYPE_PRIVATE12', 'SPINTERFERENCE_NONE',
    'DISPID_SRRPhraseInfo', 'ISpeechPhraseAlternate', 'SPAR_Low',
    'SpPhraseInfoBuilder', 'SAFT8kHz16BitMono', 'DISPID_SPRuleName',
    'ISpeechRecoGrammar', 'SVSFIsFilename',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSAddRuleTransition',
    'SPAUDIOSTATE', 'SpeechTokenKeyFiles', 'SP_VISEME_3',
    'SPINTERFERENCE_TOOSLOW', 'eLEXTYPE_MORPHOLOGY', 'SRADynamic',
    'SVSFDefault', 'DISPID_SVSyncronousSpeakTimeout', 'SPWF_SRENGINE',
    'DISPID_SLPsItem', 'SP_VISEME_8', 'SECFIgnoreCase', 'SRESoundEnd',
    'SpeechCategoryPhoneConverters', 'SPPHRASEPROPERTY',
    'SAFT24kHz8BitMono', 'SVEEndInputStream', 'DISPID_SFSClose',
    'DISPID_SpeechLexiconWords',
    'DISPID_SRCAudioInInterferenceStatus', 'SRTAutopause',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPIStartTime',
    'eLEXTYPE_PRIVATE7', 'SpeechAudioFormatGUIDText', 'SVP_0',
    'DISPID_SBSSeek', 'ISpRecognizer3', 'SSFMCreateForWrite',
    'DISPID_SPEActualConfidence', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRSTNextState', 'SpeechAddRemoveWord', 'SPCONTEXTSTATE',
    'SVP_12', 'ISpeechPhraseInfoBuilder', 'SpSharedRecoContext',
    'DISPID_SLWPronunciations', 'DISPID_SASFreeBufferSpace',
    'ISpObjectToken', 'DISPID_SGRsCount', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechAudioFormat', 'SpeechVoiceSpeakFlags',
    'eLEXTYPE_RESERVED7', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechInterference', 'SP_VISEME_20', 'SRSEDone',
    'SpeechAllElements', 'ISpEventSink', 'SFTSREngine',
    'SGLexicalNoSpecialChars', 'SVP_17', 'DISPID_SpeechDataKey',
    'STSF_AppData', 'DISPID_SRCResume',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_SOUND_START',
    'SP_VISEME_21', 'SpeechWordType', 'ISpLexicon',
    'SPCT_SUB_COMMAND', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechPhraseInfo', 'SP_VISEME_10',
    'DISPID_SpeechPhraseRule', 'SpObjectTokenCategory',
    'ISpNotifySink', 'SPEI_START_SR_STREAM', 'SP_VISEME_7',
    'SpeechVoiceEvents', 'DISPID_SOTCreateInstance',
    'SpStreamFormatConverter', 'DISPID_SVEventInterests',
    'DISPID_SOTCategory', 'DISPID_SRGCmdSetRuleState',
    'SAFTCCITT_uLaw_11kHzMono', 'SpMMAudioOut', 'SP_VISEME_18',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRGetPropertyNumber', 'SVEViseme', 'DISPID_SPRulesItem',
    'SAFT11kHz8BitMono', 'SPPS_SuppressWord',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SAFType',
    'SPSERIALIZEDPHRASE', 'SREPhraseStart', 'DISPID_SVResume',
    'SWPUnknownWordUnpronounceable', 'SpeechRecoProfileProperties',
    'SVP_2', 'SPAUDIOBUFFERINFO', 'STSF_LocalAppData',
    'SAFT22kHz16BitMono', 'SPEI_PHONEME', 'DISPID_SpeechRecoContext',
    'SAFT44kHz16BitStereo', 'SpeechDataKeyLocation', 'SP_VISEME_11',
    'DISPID_SOTGetStorageFileName',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_PRIVATE17', 'SVP_21', 'SVPAlert',
    'SpeechGrammarTagWildcard', 'DISPID_SAFGetWaveFormatEx',
    'SREBookmark', 'SREFalseRecognition',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVP_6',
    'DISPID_SRCEFalseRecognition', 'SWPUnknownWordPronounceable',
    'eLEXTYPE_RESERVED4', 'SAFTADPCM_11kHzStereo',
    'DISPID_SGRAddResource', 'SAFT12kHz8BitMono',
    'SPDKL_CurrentConfig', 'SPSModifier', 'DISPID_SDKSetStringValue',
    'SAFTTrueSpeech_8kHz1BitMono', 'eWORDTYPE_DELETED',
    'DISPID_SASNonBlockingIO', 'SDTReplacement',
    'SAFTADPCM_44kHzStereo', 'SASPause', 'ISpeechLexicon',
    'SPPS_Modifier', 'ISpeechRecoResult', 'SASRun', 'ISpProperties',
    'SP_VISEME_9', 'DISPID_SRGRules', 'SVESentenceBoundary',
    'DISPID_SpeechMemoryStream', 'ISpeechLexiconPronunciation',
    'ISpeechCustomStream', 'SPEI_SOUND_END', 'SVP_8',
    'SPFM_NUM_MODES', 'Speech_Max_Word_Length',
    'DISPID_SRCEAdaptation', 'DISPID_SPRNumberOfElements',
    'DISPID_SRCEStartStream', 'SpeechTokenShellFolder',
    'DISPID_SOTDataKey', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRAudioInputStream', 'DISPID_SPIEngineId',
    'SpeechCategoryRecognizers', 'ISpNotifySource',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechVoiceEvent',
    'SAFT11kHz16BitStereo', 'SPPHRASEREPLACEMENT',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPIProperties',
    'DISPID_SRCESoundEnd', 'DISPID_SpeechPhoneConverter',
    'DISPID_SABIEventBias', 'SPCT_COMMAND',
    'DISPID_SRCEPropertyStringChange', 'SVSFVoiceMask',
    'SAFTADPCM_8kHzStereo', 'SPRST_INACTIVE', 'DISPID_SGRSRule',
    'DISPID_SRGDictationUnload', 'DISPID_SVSInputWordPosition',
    'DISPID_SRCBookmark', 'SpPhoneConverter', 'SPEI_RECOGNITION',
    'SPINTERFERENCE', 'SRSInactiveWithPurge', 'SPBINARYGRAMMAR',
    'eLEXTYPE_RESERVED9', 'SAFT48kHz16BitMono',
    'ISpeechTextSelectionInformation', 'DISPID_SVEEnginePrivate',
    'DISPID_SMSALineId', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SWFESamplesPerSec', 'SECLowConfidence',
    'DISPID_SGRAddState'
]

_check_version('1.1.14', 1618949026.665043)
